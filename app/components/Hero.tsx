...
export function Hero() {
  return (
    <Container className="pt-20 pb-16 text-center lg:pt-32">
      <h1 className="font-display mx-auto max-w-4xl text-5xl font-medium tracking-tight text-foreground sm:text-7xl">
        Track{" "}
      ...
      <p className="text-subtle mx-auto mt-6 max-w-2xl text-lg tracking-tight">
