...
const NewAreaPlaceholder: React.FC = () => {
  return (
    <Link
      to="/areas/new"
      className="group grid aspect-video place-content-center rounded-lg border-2 border-dashed border-neutral bg-neutral-subtle text-center transition hover:border-primary hover:bg-primary-subtle focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
    >
